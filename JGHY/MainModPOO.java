...
class MainModPOO {
    ...
    public static void main(String[] args) {
        ...
        // Creamos un objeto de la clase ModuloPOO
        ModuloPOO s1 = new ModuloPOO();
        ...
        do {
            ...
            System.out.println("1. Modulo de dos números");
            ...
            switch (opcion) {
                case 1:
                    ...
                    // Mostramos el resultado del módulo utilizando el método calcularModulo()
                    System.out.println("El módulo de los números es: " + s1.calcularModulo());
