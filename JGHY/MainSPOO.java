...
class MainSPOO {
    ...
    public static void main(String[] args) {
        ...
        // Creamos un objeto de la clase SumaPOO
        SumaPOO s1 = new SumaPOO();
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    // Mostramos el resultado de la suma utilizando el método calcularSuma()
                    System.out.println("La suma de los números es: " + s1.calcularSuma());
