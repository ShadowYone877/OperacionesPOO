// Definición de la clase ModuloPOO
...
class ModuloPOO {
    ...
    // Constructor vacío de la clase ModuloPOO
    ModuloPOO() {

    }

    // Método para calcular el modulo de los dos números
    public int calcularModulo() {
        return num % num2; // Retorna el modulo de num y num2
    }
