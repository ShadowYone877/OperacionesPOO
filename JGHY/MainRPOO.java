...
class MainRPOO {
    ...
    public static void main(String[] args) {
        ...
        // Creamos un objeto de la clase RestaPOO
        RestaPOO s1 = new RestaPOO();
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    // Mostramos el resultado de la resta utilizando el método calcularResta()
                    System.out.println("La resta de los números es: " + s1.calcularResta());
