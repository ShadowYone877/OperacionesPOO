...
class MainM { // Declaramos la clase principal 'MainM'.
    public static void main(String[] args) { // Método principal que se ejecuta al iniciar el programa.
        ...
        do {
            ...
            switch (op) {
                case 1:
                    // Si el usuario elige la opción 1, creamos un objeto de la clase 'Multiplicacion' para realizar la multiplicación.
                    Multiplicacion mu = new Multiplicacion();
                    
                    // Pedimos al usuario que ingrese el primer número para realizar la multiplicación.
                    System.out.print("Ingresa el primer numero: ");
                    // Almacenamos el valor ingresado en la variable 'num1' del objeto 'mu'.
                    mu.setNum1(sc.nextInt());
                    
                    // Pedimos al usuario que ingrese el segundo número para realizar la multiplicación.
                    System.out.print("Ingresa el segundo numero: ");
                    // Almacenamos el valor ingresado en la variable 'num2' del objeto 'mu'.
                    mu.setNum2(sc.nextInt());
                    
                    // Calculamos y mostramos el resultado de la multiplicación.
                    System.out.println("El resultado de la multiplicacion es: " + (mu.getNum1() * mu.getNum2()));
                    System.out.println("---------------------------------");
