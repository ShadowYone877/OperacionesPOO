...
class MainS { // Declaramos la clase principal 'MainS'.
    public static void main(String[] args) { // Método principal que se ejecuta al iniciar el programa.
        ...
        do {
            ...
            switch (op) {
                case 1:
                    // Si el usuario elige la opción 1, creamos un objeto de la clase 'Suma' para realizar la suma.
                    Suma su = new Suma();
                    
                    // Pedimos al usuario que ingrese el primer número para realizar la suma.
                    System.out.print("Ingresa el primer numero: ");
                    // Almacenamos el valor ingresado en la variable 'num1' del objeto 'su'.
                    su.setNum1(sc.nextInt());
                    
                    // Pedimos al usuario que ingrese el segundo número para realizar la suma.
                    System.out.print("Ingresa el segundo numero: ");
                    // Almacenamos el valor ingresado en la variable 'num2' del objeto 'su'.
                    su.setNum2(sc.nextInt());
                    
                    // Calculamos y mostramos el resultado de la suma.
